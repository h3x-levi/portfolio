  ...
  return (
    <footer className="py-6 text-center text-slate-400 text-sm">
      <div className="hidden md:flex fixed bottom-0 left-12 flex-col items-center space-y-6 after:content-[''] after:w-px after:h-24 after:bg-slate-400 after:block">
        <a href="https://github.com/akshaymondal" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-teal-300 transition-colors hover:-translate-y-1">
