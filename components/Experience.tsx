...
const amazonRoles: ExperienceType[] = [
  {
    ...
    logo: '/amazon.svg',
    description: [
      'Incident detection, triage, and escalation across gaming & cloud platforms; handling Sev2–Sev5 tickets with strict SLA adherence.',
      'Monitor alerts, dashboards, and automated tests; perform RCA for critical issues and optimize alarm thresholds.',
      'Manage game ingestion workflows, metadata, assets, configs, ratings, and regional releases.',
      'Execute software deployments and launcher updates; manage AWS EC2/S3 resources and infrastructure tasks.',
      'Coordinate certification processes, testing workflows, and shader generation/pre-scaling.',
      'Cross-team communication with vendors, Dev, SRE, QA, and support teams; deliver customer-facing service updates.',
      'Maintain SOPs, runbooks, and operational documentation; contribute to automation improvements and service reliability.',
    ],
    tech: [
      'AWS (EC2, S3)',
      'Incident Management',
